...
/*
 * pthread/limits.h : machine and opertaing system limit definitions
 */


#ifndef __PTHREAD_LIMITS_H
#define __PTHREAD_LIMITS_H

/* POSIX defined minimums */
#define _POSIX_THREAD_DESTRUCTOR_ITERATIONS	4
#define _POSIX_THREAD_KEYS_MAX			128
#define _POSIX_THREAD_THREADS_MAX 		64

/* MIPS RTPX implementation */
...
/* POSIX.4 features */
#define RTSIG_MAX				32
#define SIGQUEUE_MAX				1 /* XXX */
#define DELAYTIMER_MAX				INT_MAX
#define TIMER_MAX				INT_MAX
#define SEM_NSEMS_MAX				INT_MAX
#define SEM_VALUE_MAX				INT_MAX
#define MQ_OPEN_MAX				INT_MAX
#define MQ_PRIO_MAX				INT_MAX

#endif /* __PTHREAD_LIMITS_H */
