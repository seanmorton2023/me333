...
#pragma	printf_check(vsprintf) const
    ...
    define_smartio_variants(int,vsnprintf,char *, size_t, const char *, va_list);
    extern int asprintf (char **, const char *, ...);
    define_smartio_variants(int,asprintf,char **, const char *, ...);
    extern int vasprintf (char **, const char *, va_list);
    define_smartio_variants(int,vasprintf,char **, const char *, va_list);
    extern int __vasprintf (char **, const char *, va_list);
    define_smartio_variants(int,__vasprintf,char **, const char *, va_list);
#endif
