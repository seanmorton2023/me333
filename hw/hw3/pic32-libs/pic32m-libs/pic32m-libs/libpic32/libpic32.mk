...
CFLAGS += $(OPTIM) $(VAR) $(GPOPT) -DNDEBUG=1 -D__LIBBUILD__ -I$(ROOT)/include -I$(ROOT)/../include -g1 -fframe-base-loclist -mno-smart-io -Wcast-align -Wall -mchp-stack-usage
...
install: libpic32.a startup_modules
	...
	cp $(ROOT)/startup/*.S $(LIBDESTDIR)/
	cp $(ROOT)/startup/software-debug-break.c $(LIBDESTDIR)/software-debug-break.c
