...
DEBUG	= -g1 -fframe-base-loclist -fvar-tracking
ASSERT	=-DNDEBUG=1
CFLAGS	=$(OPTIM) $(VAR) $(GPOPT) $(DEBUG) $(ASSERT) $(EXCEPT) -ffreestanding -ffunction-sections -mchp-stack-usage
ASFLAGS	=$(OPTIM) $(VAR) $(GPOPT) $(ASSERT) $(EXCEPT) -ffreestanding -ffunction-sections -mchp-stack-usage
STRIPFLAGS =-X
ARCH	=mips
